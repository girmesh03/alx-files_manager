    ...
    it('+ Fetches first page with no page query', function (done) {
      ...
      request
        ...
        .end((requestErr, res) => {
          ...
          expect(res.body.some((file) => file.name === mockFiles[0].name)).to
            .be.true;
          expect(res.body.some((file) => file.name === mockFiles[1].name)).to
            .be.true;
          done();
        });
    });
    ...
    it('+ Fetches first page with no page query and parentId', function (done) {
      ...
      request
        ...
        .end((requestErr, res) => {
          ...
          expect(res.body.some((file) => file.name === mockFiles[2].name)).to
            .be.true;
          done();
        });
    });
